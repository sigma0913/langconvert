...
const canhandakuon_hira_s1do = ["か","き","く","け","こ","は","ひ","ふ","へ","ほ"]
const handakuon_hira_s1do = ["か゚","き゚","く゚","け゚","こ゚","ぱ","ぴ","ぷ","ぺ","ぽ","か゚","き゚","く゚","け゚","こ゚","ぱ"]
const kata_s1do_s1do = ["ア","イ","ウ","エ","オ","カ","キ","ク","ケ","コ","サ","シ","ス","セ","ソ","タ","チ","ツ","テ","ト","ナ","ニ","ヌ","ネ","ノ","ハ","ヒ","フ","ヘ","ホ","マ","ミ","ム","メ","モ","ヤ","ユ","ヨ","ラ","リ","ル","レ","ロ","ワ","ヰ","ヱ","ヲ","ン","ア","イ","ウ","エ","オ","カ"]
const youon_kata_s1do_s1do = ["ァ","ィ","ゥ","ェ","ォ","ヵ","ヶ","ッ","ャ","ュ","ョ","ヮ","ァ","ィ","ゥ","ェ","ォ","ヵ"]
const dakuon_kata_s1do_s1do = ["ガ","ギ","グ","ゲ","ゴ","ザ","ジ","ズ","ゼ","ゾ","ダ","ヂ","ヅ","デ","ド","バ","ビ","ブ","ベ","ボ","ガ","ギ","グ","ゲ","ゴ","バ"]
const canhandakuon_kata_s1do_s1do = ["カ","キ","ク","ケ","コ","ハ","ヒ","フ","ヘ","ホ"]
const handakuon_kata_s1do_s1do = ["カ゚","キ゚","ク゚","ケ゚","コ゚","パ","ピ","プ","ペ","ポ","カ゚","キ゚","ク゚","ケ゚","コ゚","パ"]
...
function doconvert_s1() {
    ...
    for (let i = 0; i < beforearray.length; i++) {
        if (canhandakuon_hira_s1do.indexOf(beforearray[i]) != -1) {
            ...
            aftertext = aftertext + canhandakuon_hira_s1do[handakuon_hira_s1do.indexOf(beforearray[i]) - 6] + "゚";
        } else if (canhandakuon_kata_s1do_s1do.indexOf(beforearray[i]) != -1) {
            if (beforearray[i+1] == "゚") {
                aftertext = aftertext + handakuon_kata_s1do_s1do[canhandakuon_kata_s1do_s1do.indexOf(beforearray[i]) + 6];
                i++;
            } else {
                aftertext = aftertext + kata_s1do_s1do[kata_s1do_s1do.indexOf(beforearray[i]) + 6];
            }
        } else if (kata_s1do_s1do.indexOf(beforearray[i]) != -1) {
            aftertext = aftertext + kata_s1do_s1do[kata_s1do_s1do.indexOf(beforearray[i]) + 6];
        } else if (youon_kata_s1do_s1do.indexOf(beforearray[i]) != -1) {
            aftertext = aftertext + youon_kata_s1do_s1do[youon_kata_s1do_s1do.indexOf(beforearray[i]) + 6];
        } else if (dakuon_kata_s1do_s1do.indexOf(beforearray[i]) != -1) {
            aftertext = aftertext + dakuon_kata_s1do_s1do[dakuon_kata_s1do_s1do.indexOf(beforearray[i]) + 6];
        } else if (handakuon_kata_s1do_s1do.indexOf(beforearray[i]) != -1) {
            aftertext = aftertext + canhandakuon_kata_s1do_s1do[handakuon_kata_s1do_s1do.indexOf(beforearray[i]) - 6] + "゚";
        } else {
